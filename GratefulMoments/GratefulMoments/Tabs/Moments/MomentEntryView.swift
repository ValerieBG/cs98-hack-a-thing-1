...
import SwiftUI
import PhotosUI // provides basic access to the photo library on the device
import SwiftData
...
struct MomentEntryView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .scrollDismissesKeyboard(.interactively) // dismiss the keyboard when it’s scrolled offscreen
